 ...
 *    example 3D mainCamera controls.
 *
 ...
 *  while raw motion is better for controlling for example a 3D mainCamera.  Because
 ...
 *
 *  __Do not use this function__ to implement things like mainCamera controls.  GLFW
